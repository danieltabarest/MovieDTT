    ...
    public class AddToListPageViewModel : BaseViewModel
    {
        ...
        private async Task AddMovieToList(CustomList customList)
        {
            ...
            try
            {
                ...
                if (movie == null)
                {
                    var newMovie = new MovieDTT.Models.Movie
                    {
                ...
                else
                {
                    ...
                    {
                        result = false;
                        await DisplayDialog("MovieDTT", "This movie is already in other list", "Ok");
                    }
                    else
                    {
			...
			if (result)
			{
				await DisplayDialog("MovieDTT", "Movie added to list.", "Ok");
				await GoBack();
			}
        }
