...
namespace MovieDTT.ViewModels
{
	public class SearchMoviePageViewModel : BaseViewModel
	{
		...
		private List<MovieDTT.Core.Models.DetailedMovie> _searchList;
		public List<MovieDTT.Core.Models.DetailedMovie> SearchList
		{
			...
			get
			{
				if (_goToDetailPage == null)
				{
					_goToDetailPage = new DelegateCommand<ItemTappedEventArgs>(async selected =>
					{
						...
						var movie = selected.Item as MovieDTT.Core.Models.DetailedMovie;
